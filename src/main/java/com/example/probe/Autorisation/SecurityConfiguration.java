...
public class SecurityConfiguration  {
    ...
    protected void configure(HttpSecurity http) throws Exception {
      http.authorizeRequests()
                                        ...
                                        .requestMatchers(antMatcher(HttpMethod.POST,"/api/pizzas/new-pizza/")).hasAnyRole("ROLE_ADMIN")
                                        .requestMatchers(antMatcher(HttpMethod.PUT,"/api/pizzas/update")).hasAnyRole("ROLE_ADMIN")
                                        .requestMatchers(antMatcher(HttpMethod.DELETE,"/api/pizzas/delete")).hasAnyRole("ROLE_ADMIN")
                                        .requestMatchers(antMatcher(HttpMethod.POST,"/api/caffe/new-caffe")).hasAnyRole("ROLE_ADMIN")
                                        .requestMatchers(antMatcher(HttpMethod.PUT,"/api/caffe/update")).hasAnyRole("ROLE_ADMIN")
                                        .requestMatchers(antMatcher(HttpMethod.DELETE,"/api/caffe/delete")).hasAnyRole("ROLE_ADMIN")
                                        .requestMatchers(antMatcher(HttpMethod.GET,"/api/user/get-user")).hasAnyRole("ROLE_ADMIN")
                                        .requestMatchers(antMatcher(HttpMethod.POST,"/api/user/create-user")).hasAnyRole("ROLE_ADMIN")
                                        .requestMatchers(antMatcher(HttpMethod.PUT,"/api/user/update{{id}}")).hasAnyRole("ROLE_ADMIN")
                                        .requestMatchers(antMatcher(HttpMethod.DELETE,"/api/user/delete{{id}}")).hasAnyRole("ROLE_ADMIN")
